          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Security Details Update<small>Change password for unauthorize person will not access your account</small></h2>
				  ...
				  <form class="form-horizontal form-label-left" novalidate action="/demo/newadmin/user-changepassword.php" method="post" enctype="multipart/form-data">
								
                      <span class="section">Password Authority</span>
											...
											<div class="item form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12" for="inputReadOnly">Old Password</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="password"  class="form-control col-md-7 col-xs-12"   name="oldpassword"  data-validate-length-range="3" data-validate-words="1" required="required" >
												</div>
											</div>
											<div class="item form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12" for="inputReadOnly">New Password</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
												<input id="password" type="password" name="password" data-validate-length-range="3" class="form-control col-md-7 col-xs-12" required="required">
												</div>
											</div>
											<div class="item form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12" for="inputReadOnly">Confirm New Password</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<button class="btn btn-primary center" type="submit">Change Password</button></div>
							  </div>
