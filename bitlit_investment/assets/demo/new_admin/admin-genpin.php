            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <form class="form-horizontal form-label-left" novalidate action="/demo/newadmin/admin-genpin.php" method="post" enctype="multipart/form-data">
								
                      <span class="section">Generate Pin</span>

									
													<div class="item form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12" for="inputReadOnly">Total Quantity</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
                                                                                                    <input type="text"  class="form-control col-md-7 col-xs-12"   name="pinqty"  data-validate-length-range="1" required="required" >
												</div>
											</div>
                      
                                                                                        <div class="item form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12" for="inputReadOnly">Select Pin Point</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
                                                                                                    
                                                                                                    <select name="pintype" class="form-control col-md-7 col-xs-12">
                                                                                                        <option value='5'>0.00 PV (0 INR)</option><option value='2'>1.00 PV (3000 INR)</option><option value='3'>2.00 PV (7500 INR)</option><option value='4'>3.00 PV (12000 INR)</option><option value='1'>4.00 PV (15000 INR)</option>                                                                                                    </select> 
								...
								<button class="btn btn-primary center" type="submit">Pin Generate</button></div>
							  </div>
