    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2> Add Album<small> Create Album and then Upload photo on perticular album</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" novalidate action="/demo/newadmin/admin-gallery.php" method="post" enctype="multipart/form-data">

                            <span class="section">Gallery Upload</span>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="inputReadOnly">Select Photo Album  </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    
									<select class="form-control" id="album" name="albumname" required="required">
									<option value="">Select Gallery Album</option>
									<option value='5'>asw</option><option value='6'>new album</option><option value='7'>mm</option><option value='8'></option><option value='9'>tes</option><option value='10'>tes</option><option value='11'>santosh</option><option value='12'>nitr0</option><option value='13'>shreya</option><option value='14'>Avdhesh Solanki</option>									</select><a href='admin-galleryalbum.php' class='btn btn-primary'> <i class='fa fa-camera'></i> Create New Photo Album</a>
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="inputReadOnly">Serial No (Gallery Sorting)</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number" class="form-control col-md-7 col-xs-12" name="sno" data-validate-minmax="1,100"  required="required" >
                                </div>
                            </div>
							
							<div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="inputReadOnly">Photo Caption</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" class="form-control col-md-7 col-xs-12" name="caption">
                                </div>
                            </div>
                             <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="inputReadOnly">Image Upload</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <button class="btn btn-primary center" type="submit">Upload</button>
                                </div>
                            </div>
