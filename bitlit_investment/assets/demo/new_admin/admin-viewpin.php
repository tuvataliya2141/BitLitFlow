...
<script type="text/javascript">
    function checkAll()
    {
        for (var i = 0; i < document.pinassign.elements.length; i++)
        {
            var e = document.pinassign.elements[i];
            if ((e.name != 'allbox') && (e.type == 'checkbox'))
            {
                e.checked = document.pinassign.allbox.checked;
            }
        }
    }
    ...
    {
        $("#sponser").ready(function () {

            $.get("../user/checkuser.php?id=" + id, function (data) {
                if (data == "WrongId") {
                    $("#sponser").val('');
                }
                $("#sponserdiv").html(data);
            })
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Check total stat pin details<small>How many used and how many pending pins</small></h2>
            ...
            <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats  btn-danger" style="background:#ce753c">
            ...
            <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats btn-primary" style="background:#337ab7">
                    ...
                    <h3>Used Pin</h3>
                    <p>Total pins used record.</p>
                </div>
            </div>
            <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats btn-dark" style="background:#019692" >
                  <div class="icon"><!--<i class="fa fa-sort-amount-desc"></i>--></div>
                    <div class="count">1482</div>
                    <h3>Balance Pins</h3>
                    <p>Un-used Pin .</p>
                </div>
            </div>
                        ...
                        <div align="right">
                            <a  href='printpin.php' target="_blank" class="btn btn-default" ><i class="fa fa-print"></i> Print</a>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" novalidate action="/demo/newadmin/admin-viewpin.php" method="get" enctype="multipart/form-data">



                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="inputReadOnly">Pin Search</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text"  class="form-control col-md-7 col-xs-12"   name="pinid"  data-validate-length-range="3" data-validate-words="1" required="required" >
...
<form name='pinassign' method ='post' action ='assignpin.php'> <table class='table table-bordered'>
			<thead><tr class='headings'><th>&nbsp;</th><th>Sr No</th><th width=50>Pin No</th><th>Status</th><th>User Id</th><th>Assign User</th><th>PV</th><th>Generte date</th><th>Transfer Date</th></tr><tr>
			<td>
		<input type='checkbox' value='on' name='allbox' onClick='checkAll();' /></td><td><font size='2'>Select All</font></td><td colspan=4>User Id <input type='text' name='userassign' onblur='getsponser(this.value)' style='text-transform:uppercase;'></td><td><div id='sponserdiv'></div>
			</td>
<td colspan=2><button class='btn btn-info center' type='submit'>Assign Pins</button></td>
	</tr> <input type='hidden' name='pinstat' value='0'><tr><td colspan=9  align='center'></td></tr></table></form>
