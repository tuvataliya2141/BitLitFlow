    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2> Latest News Update Update<small>Add Latest Company News and Events</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" novalidate action="/demo/newadmin/admin-news.php" method="post" enctype="multipart/form-data">

                            <span class="section">Company News</span>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="inputReadOnly">New Title </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text"  class="form-control col-md-7 col-xs-12"   name="ntitle"  value="" data-validate-length-range="3" data-validate-words="1" required="required" >
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>New Description <small> Company New description</small></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <textarea name="ndesc" id="descr" rows="8"></textarea>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <button class="btn btn-primary center" type="submit">Add News</button>
                                </div>
                            </div>
