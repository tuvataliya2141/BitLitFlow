    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Check user pin search<small>How many transfer and used</small></h2>
            ...
            <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats  btn-danger" style="background:#ab0b0b">
                  <div class="icon"><!--<i class="fa fa-caret-square-o-right"></i>--></div>
                    ...
                    <h3>Total Transfer Pin</h3>
                    <p>Total pin transfer to members.</p>
                </div>
            </div>
            <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats btn-primary" style="background:#337ab7">
                    <div class="icon"></div>
                    <div class="count">0</div>
                    <h3>Total Used Pin</h3>
                    <p>How many pins used by member.</p>
                </div>
            </div>
            <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>User search<small>How many tranfer pin record</small></h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                            </li>
                    ...
                    <div class="x_content">
                      ...
                      <form class="form-horizontal form-label-left" novalidate action="/demo/newadmin/admin-usertransfer.php" method="get" enctype="multipart/form-data">
    
                       <table class="table col-md-6 col-sm-6 col-xs-12" style="width:50%">                  
                            <thead>
                                <tr>  <td>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                     <input type="text"  class="form-control has-feedback-left"   name="userid" placeholder="userId" data-validate-length-range="3" data-validate-words="1" required="required" >
