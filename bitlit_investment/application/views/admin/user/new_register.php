    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            ...
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="<?php echo base_url('admin/user'); ?>" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control select2me" name="upliner_id" id="upliner_id" onchange="getUplinerName(this.value)">
                                            <option value="">Select...</option>
                                            <?php foreach ($upliner_data as $upliner) { ?>
                                                <option value="<?= $upliner->id; ?>" <?= ($upliner->upliner_id == set_value('upliner_id')) ? 'selected="selected"' : ''; ?>><?= $upliner->user_id; ?></option>
                                            <?php } ?>
                                        </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8" id="upliner_data">
                                        <input type="text" id="upliner_name" disabled="disabled" name="upliner_name" value="<?php echo set_value('upliner_name'); ?>" data-required="1" class="form-control" />
...
<script>
                                            ...
                                            function getUplinerName(sid) {
                                                ...
                                                if (sid != '')
                                                {
                                                    $.ajax({
                                                        type: 'POST',
                                                        url: "<?php echo base_url() ?>user/getUplinerName/",
                                                ...
                                                if (sid != '')
                                                {
                                                    $.ajax({
                                                        type: 'POST',
                                                        url: "<?php echo base_url() ?>user/checkUpliner/",
                                                        data: {primary_customer: sid},
                                                        dataType: 'json',
                                                        success: function (response) {
                                            ...
                                            function getRefferalName(sid) {
                                                ...
                                                if (sid != '')
                                                {
                                                    $.ajax({
                                                        type: 'POST',
                                                        url: "<?php echo base_url() ?>user/getRefferalName/",
                                                        data: {primary_customer: sid},
                                                        dataType: 'json',
                                                        success: function (response) {
                                                            //alert(response);
