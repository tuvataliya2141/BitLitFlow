                    ...
                    <tbody>
                        ...
                        foreach ($registration as $key => $value) {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <?php
                                    foreach ($capping_data as $amount) {
                                        if ($amount->id == $value->capping) {
                                            echo $amount->capping_per_day_month / 30;
                                        }
                                    }
                                    ?>
                                </td>
        ...
        <!--<td>
            ...
            <input type="hidden" name="paument_value" id="paument_value" value="">
                                ...
                                <td>
                                    ...
                                    <?php } else {
                                        ?>
                                        <a href="<?php echo base_url('admin/user/capping_payment_update/' . $value->id); ?>" class="btn btn-circle btn-sm blue">Pay</a>
                                    <?php } ?>
