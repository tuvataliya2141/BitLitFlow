...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="<?php echo base_url('admin/user/bank_detail'); ?>" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="file" id="cheque_image"  name="cheque_image"  data-required="1" class="form-control" />
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Upload Pan Card No.</label>
                                            <div class="col-md-8">
