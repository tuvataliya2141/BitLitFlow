...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?= base_url('login/check_password'); ?>">Change Password</a>
        </li>
    </ul>                            
</div>
<!-- END PAGE BAR -->
    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            ...
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form method="post" action="<?php echo base_url(); ?>user/change_password" id="frmchangepassword" name="frmchangepassword" class="form-horizontal">
                    <div class="form-body">
