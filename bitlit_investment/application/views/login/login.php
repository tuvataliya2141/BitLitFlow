...
<body class="login">
    ...
    <div class="content">
        ...
        <form class="login-form" action="<?php echo base_url(); ?>login" method="post" id="frmlogin">
            ...
            <div class="forget-password">
               <h4><a style="color:#ffffff;" href="<?php echo base_url(); ?>login/forgotpassword" id="forget-password">Forgot your password ?</a></h4>                   
		<a style="color:#ffffff;" href="<?php echo base_url(); ?>login/sign_up">Sign Up</a>                   
            </div>
        </form>
    </div>
