...
class Team extends CI_Controller {
    ...
    public function index() {
       ...
       // $user_id = $this->session->userdata('user_id');
        ...
        $data['view'] = 'admin/team/group_team';
    ...
    public function my_direct() {
       ...
       // echo "<pre>"; print_r($data); die;
        $data['view'] = 'admin/team/my_direct';
        $this->load->view('admin/admin_master', $data);
    }
    ...
    public function my_downline() {
        ...
        //$data['refferal_data'] = $this->user_model->getmyDirectRefferal($user_id);
       // echo "<pre>"; print_r($data); die;
        $data['view'] = 'admin/team/my_downline';
        $this->load->view('admin/admin_master', $data);
    }
    ...
    public function get_group() {
        $user_id = $this->session->userdata('user_id');
        if ($user_id) {
            $data['team_data'] = $this->common->getRegistrationByadmin();
           // echo '<pre>'; print_r($data['team_data']); die;
            
            echo json_encode(array('view' => $this->load->view('admin/team/ajax_group_team', $data, true)));
...
//echo $data['mobile_data']->site_id;
    ...
    public function new_register($uid = "", $pos = "") {
        ...
        $data['view'] = 'admin/team/new_register';
