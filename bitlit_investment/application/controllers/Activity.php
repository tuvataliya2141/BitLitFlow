...
class Activity extends CI_Controller {
    ...
    public function request_detail() {
       ...
       // echo "<pre>"; print_r($_POST); die;
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            //echo "<pre>"; print_r($data); die;   
            if ($data) {
                redirect(base_url('activity/id_request_detail'));
            } else {
    ...
    public function id_request_detail() {
        ...
        //echo "<prE>"; print_r($data); die;
        $data['view'] = 'activity/request_detail';
        $this->form_validation->set_error_delimiters('<div id="alrt" class="alert alert-danger" style="padding:5px;margin-top:5px;">', '</div>');
    ...
    public function ticket_check() {
        $data['view'] = 'activity/ticket_check';
        $this->load->view('admin_master', $data);
    }
    ...
    public function ticket_detail() {
        //echo "<prE>"; print_r($data); die;
       // echo "<pre>"; print_r($_POST); die;
        $data['view'] = 'activity/ticket_detail';
        $this->form_validation->set_error_delimiters('<div id="alrt" class="alert alert-danger" style="padding:5px;margin-top:5px;">', '</div>');
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            //echo "<pre>"; print_r($data); die;   
            if ($data) {
                redirect(base_url('activity/id_ticket_detail'));
            } else {
                $this->session->set_flashdata('error', "Invalid Transaction Password.");
                redirect(base_url('activity/ticket_check'));
            }
        }
        $this->load->view('admin_master', $data);
    }
    ...
    public function resolve_ticket() {
        ...
        $data['view'] = 'activity/resolve_ticket';
        $this->load->view('admin_master', $data);
    }
